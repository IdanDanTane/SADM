...
namespace Group_2
{
    public partial class CreateEmployee : Form
    {
        ...
        {
            Employee E = new Employee(EmployeeID.Text, EmployeePhone.Text, EmployeeEmail.Text, EmployeeFirstName.Text, EmployeeLastName.Text, employeeBirthDate.Value ,(employeeType)Enum.Parse(typeof(employeeType),EmployeeType_choose.Text),true);
        }
